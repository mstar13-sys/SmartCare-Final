/* =========================================================================
   Form Helpers
   -------------------------------------------------------------------------
   Small DOM-touching utilities shared by login-form.js and signup-form.js,
   so both modules stay short and focused on their own event wiring.
   ========================================================================= */
const SmartCareFormHelpers = (() => {
  ...
  function messageContainerFor(inputEl) {
    return inputEl.closest('.field')
      || (inputEl.closest('.check-row') && inputEl.closest('.check-row').parentElement)
      || null;
  }
