...
NotificationCenter.subscribe('login:success', (data) => {
  ...
  showSuccessDialog({
    ...
    // A plain reload is enough to get to the right dashboard: the PHP
    // bootstrap on every auth page checks the session on load and
    // redirects signed-in users to their role's dashboard automatically.
